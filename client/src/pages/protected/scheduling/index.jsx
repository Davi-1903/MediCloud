        ...
        <>
            <ProtectedRoute isPrivate={true}>
                <div className='h-full bg-[#FFF5F6] py-3'>
                    <Header />
                    <main className='w-full mt-28 flex flex-col items-center gap-5 pb-10'>
                        <section>
                        ...
                        <section className="doutores">
                            ...
                            <div className='flex gap-5 items-center'>
                                ...
                                >
                                    <div className="w-16 h-24 rounded-4xl object-cover bg-[#ffd1da]"></div>
                        ...
                        <section className='flex gap-20'>
                            <aside className='flex gap-4 h-46 items-center justify-center'>
                                <div className='w-24 h-42 rounded-full bg-[#ffd1da]'></div>
