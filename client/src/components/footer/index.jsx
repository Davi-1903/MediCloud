...
export default function Footer() {
    return (
        <footer className='relative grid min-h-150 overflow-x-hidden bg-white'>
            <Clouds />
            <div className='z-1 mx-auto grid w-full max-w-400 grid-cols-[2fr_1fr_1fr_1fr] grid-rows-[1fr_auto] gap-x-6'>
                <article className='flex flex-col gap-6 p-12'>
                    ...
                    >
                        <span className='text-base font-semibold text-color1 group-hover:text-white'>
                            Voltar para o topo
                        </span>
                        <IconArrowUp
                            size={26}
