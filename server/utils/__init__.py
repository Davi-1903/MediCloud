...
def get_env(key: str, default: str | None = None) -> str:
    ...
    :param key: O nome da variável de ambiente a ser carregada.
    :type key: str
    :param default: Um valor padrão a ser retornado se a variável de ambiente não for encontrada
    :type default: str | None
    :return: O valor da variável de ambiente ou o valor padrão, se fornecido.
    :rtype: str
    :raises ValueError: Se a variável de ambiente não for encontrada e nenhum valor padrão for fornecido.
